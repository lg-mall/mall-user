...
public class MerchantServiceImpl implements MerchantService {
    ...
    @Override
    public Response<PageStructure<MerchantPageODTO>> listByPaging(PageRequest<MerchantQueryPageIDTO> pageRequest) {
        ...
        PageStructure<MerchantPageODTO> rspDTO = new PageStructure<>();
